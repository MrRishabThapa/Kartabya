...
export default function GameStage(props: Props) {
  const { topic, phase, result, error, historyNotice, companionName, isRecording, recordingSeconds, commitNotice, qnaReady, qnaExchangeCount, onMicToggle, onDoneExplaining, onFinishTeaching, onRetry, onAnother, onBack } = props;
